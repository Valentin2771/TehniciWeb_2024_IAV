window.addEventListener("load",function() {
    ...
    document.getElementById("filtrare").onclick= function(){
        ...
        for (let prod of produse){
            ...
            let pagini=parseInt(prod.getElementsByClassName("val-pagini")[0].innerHTML);

            let cond2= (val_pagini=="toate" || cal_a<=pagini && pagini <cal_b);
